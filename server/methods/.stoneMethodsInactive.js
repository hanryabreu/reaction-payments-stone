...
// import { StoneGatewayApi, RISKY_TEST_CARD } from "./StoneGatewayApi";
...
// describe("StoneGatewayApi", function () {
//   let sandbox;
...
//   it("should return data from StoneGatewayRestfulAPI authorize", function () {
//     const cardData = {
//       name: "Test User",
...
//     const transaction = StoneGatewayApi.methods.authorize.call({
//       transactionType,
//       cardData,
//       paymentData
//     });
...
//     const amount = 19.99;
//     const results = StoneGatewayApi.methods.capture.call({
//       authorizationId,
//       amount
//     });
...
//     const authorizeStub = sandbox.stub(StoneGatewayApi.methods.authorize, "call", () => authorizeResult);
...
//   it("should call StoneGatewayApi with transaction ID", function () {
...
//     const captureStub = sandbox.stub(StoneGatewayApi.methods.capture, "call", () => captureResults);
...
//     sandbox.stub(StoneGatewayApi.methods, "capture", function () {
...
//     const refundStub = sandbox.stub(StoneGatewayApi.methods.refund, "call", () => refundResults);
...
//   it("should throw an error if transaction ID is not found", function () {
//     sandbox.stub(StoneGatewayApi.methods.refund, "call", function () {
//       throw new Meteor.Error("not-found", "Not Found");
//     });
//     const transactionId = "abc1234";
//     paymentMethod.transactionId = transactionId;
...
//     };
//     const refundStub = sandbox.stub(StoneGatewayApi.methods.refunds, "call", () => refundResults);
//     Meteor.call("example/refund/list", paymentMethod);
//     expect(refundStub).to.have.been.calledWith(refundArgs);
//   });

//   it("should throw an error if transaction ID is not found", function () {
//     sandbox.stub(StoneGatewayApi.methods, "refunds", function () {
//       throw new Meteor.Error("not-found", "Not Found");
//     });
