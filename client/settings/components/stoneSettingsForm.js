...
class StoneSettingsForm extends Component {
  constructor(props) {
    super(props);
    this.state = {
      settings: {
        merchantKey: props.settings.merchantKey,
...
StoneSettingsForm.propTypes = {
  onChange: PropTypes.func.isRequired,
  onSubmit: PropTypes.func.isRequired,
  settings: PropTypes.object
};

export default StoneSettingsForm;
