...
import { StoneSettingsForm } from "../components";

class StoneSettingsFormContainer extends Component {
  constructor(props) {
    super(props);

    this.state = {
      merchantKey: "278302390293"
    };
  ...
  handleChange(e) {
    e.preventDefault();
    this.setState({ merchantKey: e.target.value });
  }
...
StoneSettingsFormContainer.propTypes = {
...
export default composeWithTracker(composer)(StoneSettingsFormContainer);
